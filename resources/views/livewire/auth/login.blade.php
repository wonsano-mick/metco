<div wire:key="login-form-container">
    <form wire:submit.prevent="login" class="space-y-6">
        <div class="mb-6">
            ...
            <div class="relative">
                ...
                <input type="email" id="email" wire:model.defer="email" value="{{ old('email') }}" required autofocus
                    autocomplete="email"
        ...
        <div class="mb-6">
            ...
            <div class="relative">
                ...
                <input type="password" id="password" wire:model.defer="password" required autocomplete="current-password"
                    class="pl-10 w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors"
                    placeholder="••••••••">
            </div>
            @error('password')
