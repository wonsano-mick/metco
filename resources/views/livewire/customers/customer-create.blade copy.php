            ...
            <div class="px-6 py-4 border-b border-gray-200 bg-gradient-to-r from-blue-50 to-blue-100">
                <div class="flex justify-between items-center">
                    <div>
                        ...
                        <p class="text-sm text-gray-600 mt-1">Register a new customer in the banking system</p>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 gap-6 mt-4">
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-3 gap-2">
                                <label
                                    class="flex items-center space-x-2 p-2 border border-gray-300 rounded-md hover:bg-blue-50 cursor-pointer">
                                        ...
                                        <div class="space-y-1 text-center">
                                            ...
                                            <div class="flex text-sm text-gray-600 justify-center">
                                                <label
                                                    ...
                                                    <input type="file" wire:model="id_front_image" class="sr-only"
                                                        accept="image/*,.pdf">
                                                </label>
                                            </div>
                                        ...
                                        <div class="space-y-1 text-center">
                                            ...
                                            <div class="flex text-sm text-gray-600 justify-center">
                                                <label
                                                    ...
                                                    <input type="file" wire:model="id_back_image" class="sr-only"
                                                        accept="image/*,.pdf">
                                                </label>
                                            </div>
                                            <p class="text-xs text-gray-500">
                                ...
                                <div class="space-y-1 text-center">
                                    ...
                                    <div class="flex text-sm text-gray-600 justify-center">
                                        <label
                                            ...
                                            <input type="file" wire:model="profile_photo" class="sr-only"
                                                accept="image/*">
                                        </label>
                                    </div>
                                    <p class="text-xs text-gray-500">
                                ...
                                <div class="space-y-1 text-center">
                                    ...
                                    <div class="flex text-sm text-gray-600 justify-center">
                                        <label
                                            ...
                                            <input type="file" wire:model="signature_image" class="sr-only"
                                                accept="image/*">
                                        </label>
                                    </div>
                                    <p class="text-xs text-gray-500">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-4">
                        ...
                        <div>
                            ...
                            <div class="relative rounded-md shadow-sm">
                                ...
                                <input type="number" id="monthly_income" wire:model="monthly_income" step="0.01"
                                    min="0"
                        ...
                        <div>
                            ...
                            <div class="relative rounded-md shadow-sm">
                                ...
                                <input type="number" id="net_worth" wire:model="net_worth" step="0.01"
                                    min="0"
                                    class="block w-full pl-7 border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                                    placeholder="0.00">
                            </div>
                    ...
                    @foreach ($emergency_contacts as $index => $contact)
                        <div class="mb-4 p-4 border border-gray-200 rounded-lg bg-gray-50">
                            <div class="flex justify-between items-center mb-3">
                                <h4 class="text-sm font-medium text-gray-900">Emergency Contact {{ $index + 1 }}
                                </h4>
                                @if ($index > 0)
                                ...
                                <div class="flex-1">
                                    <div class="flex justify-between items-start">
                                        ...
                                        <div class="flex space-x-2">
                                            <span
                                                class="px-2 py-1 text-xs font-medium rounded {{ $status === 'active' ? 'bg-green-100 text-green-800' : ($status === 'suspended' ? 'bg-red-100 text-red-800' : 'bg-yellow-100 text-yellow-800') }}">
                                                {{ ucfirst($status) }}
                                            </span>
                                            <span
                                                class="px-2 py-1 text-xs font-medium rounded {{ $kyc_status === 'verified' ? 'bg-purple-100 text-purple-800' : ($kyc_status === 'rejected' ? 'bg-red-100 text-red-800' : 'bg-gray-100 text-gray-800') }}">
                                                {{ ucfirst($kyc_status) }}
                                            </span>
                                            <span
                                                class="px-2 py-1 text-xs font-medium rounded {{ $risk_profile === 'low' ? 'bg-green-100 text-green-800' : ($risk_profile === 'high' ? 'bg-red-100 text-red-800' : 'bg-yellow-100 text-yellow-800') }}">
                                                {{ ucfirst($risk_profile) }} Risk
                                            </span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mt-3 grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <div>
                                            ...
                                            @if ($phone_alt)
                                                <p class="text-sm text-gray-500">Alt: {{ $phone_alt }}</p>
                                            @endif
                                        </div>
                                        <div>
                                            <p class="text-xs text-gray-500">Location</p>
                                            <p class="text-sm text-gray-900">{{ $city }}, {{ $state }}
                                            </p>
                                    ...
                                    <div class="mt-3 grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <div>
                                            <p class="text-xs text-gray-500">Identification</p>
                                            <p class="text-sm text-gray-900">
                                                {{ $idTypes[$id_type] ?? ucfirst($id_type) }}: {{ $id_number }}
                                            </p>
                                            @if ($date_of_birth)
                                                <p class="text-sm text-gray-900">
                                                    DOB: {{ \Carbon\Carbon::parse($date_of_birth)->format('M d, Y') }}
                                        ...
                                        <div>
                                            ...
                                            <p class="text-sm text-gray-900">
                                                ₵{{ number_format($monthly_income, 2) }}/month</p>
                                        </div>
                                    </div>
                    ...
                    <div class="flex items-start">
                        ...
                        <div class="ml-3">
                            ...
                            <ul class="mt-2 text-sm text-gray-600 list-disc list-inside space-y-1">
                                ...
                                <li>Customer will be registered immediately upon submission</li>
                                <li>KYC verification may be required before account creation</li>
                                <li>Ensure all information is accurate before submitting</li>
                                <li>Customer number will be auto-generated upon creation</li>
                            </ul>
                        </div>
                    </div>
                </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (dobInput) {
                dobInput.addEventListener('change', function(e) {
                    if (this.value) {
                        // Dispatch event to Livewire to calculate age
                        @this.calculateAge();
                    }
                });
            }
